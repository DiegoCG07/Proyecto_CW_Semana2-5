...
<html lang="en">
    <head>
        ...
        <title>Calendario | Coyo-Clases</title>
    ...
    <body>
        ...
        <div id="titulo2">
            <span class="coyoseis">Calendario Coyo 6</span>
        </div>

        <div id="contenedor">
            <section id="contenido" class="secciones">
               <div class="calendario">
                   <div class="calendario" id="navCalendario">
                        <div class="calendario" id="flechaAntes">
                            <img class="flechas" src="../statics/media/img/anterior.png" alt="anterior">
                        </div>
                        <div class="calendario" id="datos" style="font-size: 2em;"></div>
                        <div class="calendario" id="flechaDespues">
                            <img class="flechas" src="../statics/media/img/siguiente.png" alt="siguiente">
                        </div>
                    </div>
                   <div class="calendario" id="semana">
                       <div class="calendario" id="dia">Dom</div>
                       <div class="calendario" id="dia">Lun</div>
                       <div class="calendario" id="dia">Mar</div>
                       <div class="calendario" id="dia">Mié</div>
                       <div class="calendario" id="dia">Jue</div>
                       <div class="calendario" id="dia">Vie</div>
                       <div class="calendario" id="dia">Sáb</div>
                   </div>
                   <div class="calendario" id="dias"></div>
               </div>
               <div id="fechasPredeterminadas">
                   <div></div>
               </div>
            </section>
        </div>
        ...
        <script src="../dynamics/JS/calendario.js"></script>
    </body>
</html>